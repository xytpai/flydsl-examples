...
@pytest.mark.parametrize(
    "m, n, k, block_m, block_n, block_k, stages, m_waves, n_waves, group_m, has_bias, is_hti",
    [
        (8, 4096, 4096, 16, 64, 128, 4, 1, 4, 0, True, False),
        (16, 4096, 4096, 16, 64, 128, 8, 1, 4, 0, True, False),
        (32, 4096, 4096, 16, 64, 64, 8, 1, 2, 0, True, False),
        (64, 4096, 4096, 16, 64, 128, 6, 1, 4, 0, True, False),
        (128, 4096, 4096, 32, 64, 128, 4, 2, 2, 0, True, False),
        (256, 4096, 4096, 64, 64, 64, 6, 4, 2, 4, True, False),
        ...
        (8, 7168, 2048, 16, 64, 64, 7, 1, 2, 0, True, False),
        (32, 384, 7168, 16, 64, 128, 5, 1, 2, 0, True, False),
